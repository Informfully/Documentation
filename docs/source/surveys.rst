...
.. note::
    ...
    When users answer the survey questions, the back end will store their answers, along with a copy of the question string and the question ID.
    This allows experimenters to edit the question pool while preserving the original question asked of the users when evaluating the answers.
...
For use cases involving group-specific surveys, we recommend creating two user experiments and running them in parallel.
